...
g_class2color = {'ceiling':	[227, 23, 13],  # 镉红               天花板
                 'floor':	[227, 207, 87],  # 香蕉色            地板
                 'wall':	[127, 255, 212],  # 碧绿色           墙
                 'beam':        [138, 43, 226],  # 紫罗兰色      横梁
                 'column':      [210, 105, 30],  # 巧克力色      柱
                 'window':      [128, 138, 135],  # 冷灰        窗户
                 'door':        [124, 252, 0],  # 草地绿        门
                 'table':       [255, 207, 0],  # 橙黄色        桌子
                 'chair':       [65, 105, 225],  # 品蓝         椅子
                 'sofa':        [128, 42, 42],  # 棕色          沙发
                 'bookcase':    [221, 160, 221],  # 玫红色      书柜
                 'board':       [0, 199, 140],  # 土耳其玉色     黑板
                 'clutter':     [255, 192, 203]  # 粉红色       杂物
                 }
